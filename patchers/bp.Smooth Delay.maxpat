...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.931091000000002, 169.0, 238.0, 33.0 ],
...
,
					"patching_rect" : [ 489.431090999999981, 275.0, 79.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 95.518768310546875, 0.0, 34.0, 17.0 ],
					"text" : "Time ",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.931090999999981, 232.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.931090999999981, 178.0, 105.0, 22.0 ],
...
,
					"patching_rect" : [ 396.931090999999981, 364.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Ableton Sans Bold Regular",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.431091000000038, 232.0, 41.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 304.431090999999981, 418.754272000000014, 32.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.431090999999981, 473.754272000000014, 204.0, 22.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 304.431090999999981, 373.691772000000014, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 87.0, 19.0, 42.518768310546875, 14.764644622802734 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.431090999999981, 519.754272000000014, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 489.431090999999981, 232.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 428.931090999999981, 113.0, 44.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.768767952919006, 99.2115478515625, 41.0, 17.0 ],
					"text" : "Signal",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 43.931091000000002, 220.754271999999986, 59.5, 22.0 ],
					"restore" : 					{
						"Time" : [ 99.999999999999972 ],
						"bypass" : [ 0.0 ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.931091000000002, 135.0, 82.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.455986000000003, 118.711639000000005, 37.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.657448000000002, 118.711639000000005, 37.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.858902, 118.711639000000005, 37.0, 5.0 ],
					"presentation" : 1,
